...
| [**Global News Radar**](https://github.com/EricEEEEEEE/global-news-radar) | Finance / News / AI | Source-verified, event-first Telegram radar for time-sensitive financial news. Deterministic P0/P1 rules, freshness and corroboration gates, source-bound mobile alerts, and no automated trading. |
...
[**Loopwork Skill**](https://github.com/EricEEEEEEE/loopwork-skill-claude-code) is a drop-in agent skill for people who have a software idea but can't code — in two native editions: [Claude Code](https://github.com/EricEEEEEEE/loopwork-skill-claude-code) and [OpenAI Codex](https://github.com/EricEEEEEEE/loopwork-skill-codex). Put one folder into your agent's skills directory, say "我想做一个记账工具，但我不会编程" — and it becomes your guide: interviews you one question at a time, writes a plain-language spec you can actually read, gets your approval on a plan, then runs an autonomous test-first build loop while you have coffee. You verify by clicking through a checklist, never by reading code.
